...
# systemd pam procd 
sed -i '$a\DISTRO_FEATURES_append = " systemd virtualization opengl pam pulseaudio egl procd"'  conf/local.conf # cockpit---pam  podman---virtualization podman---systemd
