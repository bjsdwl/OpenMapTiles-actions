...
# docker-ce
sed -i '$a\IMAGE_INSTALL_append += " podman podman-compose crun cgroup-lite rng-tools procps ca-certificates python3-setuptools python3-pyyaml python3-json cockpit"'  conf/local.conf
